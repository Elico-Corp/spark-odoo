...
class order(report_sxw.rml_parse):
    ...
    def _get_sale_price(self, sol_id):
        ...
        so_line    = sol_pool.browse(self.cr, 1, sol_id)
        sale_price = so_line.price_unit * (1 - so_line.discount/100)
...
report_sxw.report_sxw('report.l10n.cn.order', 'sale.order', 'addons/mmx_sale_report/report/order.rml', parser=order, header='external portrait')
