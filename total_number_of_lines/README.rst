...
`here <https://github.com/Elico-Corp/spark_odoo/issues/new?body=module:%20total_number_of_lines%0Aversion:%20{7.0}%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
